...
function draw() {
  ...
  slider1.x=windowWidth*0.25-slider1.width*0.5;
    ...
    slider3.x=windowWidth*0.75-slider3.width*0.5;
...
scale(windowWidth/1420);
  ...
  // unit=slider1.value*(windowWidth/1420);
  // space=slider2.value*(windowWidth/1420);
  // ratio=slider3.value*(windowWidth/1420);
